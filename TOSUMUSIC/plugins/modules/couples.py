...
#BOT FILE NAME
from TOSUMUSIC import app as app
from TOSUMUSIC.mongo.couples_db import _get_image, get_couple

POLICE = [
    [
        InlineKeyboardButton(
            text="𓊈𝗧𝗢𝗦𝗨 𝗕𝗢𝗧 𝗠𝗔𝗞𝗘𝗥𓊉",
            url=f"https://t.me/FREINDS_club",
        ),
    ],
]
