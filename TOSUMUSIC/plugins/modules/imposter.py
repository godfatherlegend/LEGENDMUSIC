...
from TOSUMUSIC.plugins.modules.pretenderdb import impo_off, impo_on, check_pretender, add_userdata, get_userdata, usr_data
...
VEGITA = [
    [
        ...
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇ", url=f"https://t.me/freinds_club")
    ],
]
